  ...
  return (
    ...
    className='min-h-screen flex items-center pt-20 pb-16 bg-gradient-to-r from-[#1a1a1a] via-[#202020] to-[#1a1a1a]'>
        <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between' >
            ...
            <h2 className='text-2xl md:text-3xl font-semibold mb-6 typewriter'>Full Stack Developer.</h2>
            <p  className='text-xl text-gray-300 mb-8'>Versatile full-stack developer with expertise in HTML, CSS, JavaScript, React, Node.js, and databases. I transform concepts into robust, functional, and visually appealing end-to-end web solutions.
             I consistently seek to learn new technologies. Explore my portfolio to see how I bring projects to life.</p>
